...
export const translations = {
    en: {
        ...
        hero: {
            badge: "Agricultural marketing, content and ads for Expo Agricola leads.",
            title: "A stronger corporate presence for companies that sell in the field.",
        ...
        chess: {
            ...
            title: "From the plot to a more serious market presence.",
            r1t: "Field coverage that actually feels credible.",
            r1b: "We document plots, process, applications, demos, results, teams and day-to-day operation so the company stops looking distant or improvised on social media.",
        ...
        testimonials: {
            badge: "Best Fit",
            title: "Where this type of proposal usually works best.",
            sub: "This landing is built for businesses that need clarity, seriousness and better commercial positioning, not just random posting.",
            items: [
                {
                    q: "Companies that already sell agricultural products or services and need a more solid image in front of clients and distributors.",
                    n: "Producers, suppliers and ag brands",
                    r: "Commercial positioning",
                },
                {
                    q: "Teams where technical advisors or engineers are part of the conversation and the brand needs to communicate with more order and authority.",
                    n: "Technical teams and advisor-led sales",
                    r: "Technical communication",
                },
                {
                    q: "Brands going to Expo Agricola or commercial visits that need a useful digital presence before, during and after the event.",
                    n: "Expo-focused campaigns",
                    r: "Before and after the event",
                },
            ],
        },
        pricing: {
        ...
        cta: {
            title: "If you're showing up at Expo, show up with a brand that looks ready.",
        ...
        contact: {
            ...
            sub: "Choose the channel you prefer. Both go directly to the Yawtik team.",
            whatsapp: "WhatsApp",
            email: "Email",
            whatsappDesc: "Fastest way to discuss your company, Expo needs and next step.",
    ...
    es: {
        ...
        chess: {
            ...
            title: "De la parcela a una presencia de mercado mucho mas seria.",
        ...
        grid: {
            ...
            items: [
                ...
                },
                {
                    ...
                    d: "El contenido solo no basta. Tambien diseñamos la base de anuncios para convertir atencion en conversaciones calificadas.",
                },
            ],
        },
        stats: {
        ...
        testimonials: {
            badge: "Mejor Encaje",
            title: "Donde este tipo de propuesta suele funcionar mejor.",
            sub: "Esta landing esta pensada para empresas que necesitan claridad, seriedad y mejor posicionamiento comercial, no solo publicar por publicar.",
            items: [
                {
                    q: "Empresas que ya venden productos o servicios agricolas y necesitan una imagen mucho mas solida frente a clientes, distribuidores y prospectos.",
                    n: "Productores, proveedores y marcas agro",
                    r: "Posicionamiento comercial",
                },
                {
                    q: "Equipos donde participan ingenieros o asesores tecnicos y la marca necesita comunicar con mas orden, autoridad y claridad.",
                    n: "Equipos tecnicos y ventas con asesoria",
                    r: "Comunicacion tecnica",
                },
                {
                    q: "Marcas que van a Expo Agricola o a visitas comerciales y necesitan una presencia digital util antes, durante y despues del evento.",
                    n: "Campañas enfocadas en Expo",
                    r: "Antes y despues del evento",
                },
            ],
        },
        pricing: {
            ...
            includes: [
                ...
                "Base creativa para campañas de pauta.",
            ...
            factors: [
                ...
                "Presupuesto de pauta y profundidad de campaña.",
        ...
        cta: {
            title: "Si van a salir a Expo, salgan con una marca que se vea lista.",
        ...
        contact: {
            ...
            sub: "Elige el canal que prefieras. Ambos llegan directo al equipo de Yawtik.",
            whatsapp: "WhatsApp",
            email: "Correo",
            whatsappDesc: "La via mas rapida para hablar de tu empresa, necesidades de Expo y siguientes pasos.",
